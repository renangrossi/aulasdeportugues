...
- **Pre-A1 e A1 estão 100% publicados**: 28 lições, 90 blocos de
  exercícios, 204 itens corrigíveis automaticamente.
- **A2 até C2 têm o roteiro pedagógico completo definido** em
